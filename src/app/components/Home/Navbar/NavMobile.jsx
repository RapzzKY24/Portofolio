  ...
  return (
    <>
      ...
      <div
        ...
        bg-indigo-700/90 backdrop-blur-xl border-l border-white/10 shadow-2xl
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              <div className="relative h-9 w-9 rounded-full bg-gradient-to-br from-indigo-600 via-indigo-500 to-sky-500 ring-1 ring-white/20 shadow-lg shadow-indigo-600/30 flex items-center justify-center">
        ...
        {/* CTA */}
        <div className="mt-auto px-5 py-6 border-t border-white/10">
          <Link
